...
public class lecture_8 extends AppCompatActivity {
    ...
    private Button subscribeButton, orderingItemsButton;
        ...
        itemsRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    Toast.makeText(lecture_8.this, "Items added to cart", Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(lecture_8.this, shoppinglist_7.class);
                    startActivity(intent);
                } else {
                    Toast.makeText(lecture_8.this, "No items found for this lecture", Toast.LENGTH_SHORT).show();
                }
            }

            @Override
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(lecture_8.this, "Failed to load items", Toast.LENGTH_SHORT).show();
            }
        });
    }
